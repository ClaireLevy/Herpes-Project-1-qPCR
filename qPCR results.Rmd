...
results<-read.csv("input data/cells CT and well only.csv")

#Adding in the layout that I made manually from Erik's data 
#from file "2016-03-07 florian lab cell culture.xlsx"

dat<-add_plate(file ="input data/cells qPCR plate layout.csv",results, "Wells")
...
load("input data/Cells_RNA_for_qPCR.Rdata")
...
explantCT<-read.csv("input data/explant CTs only.csv")
